      ...
      {mock.map((m, i) => (
        <div key={i} className="item card">
          <div className="item__header">
            <p className="item__date">13 de Mayo</p>
            <p className="item__id">#7010191</p>
          </div>
          <div className="item__body">
            <p className="item__title">Samsung Galaxy S20 FE 128 GB cloud navy 6 GB RAM</p>
            <p className="item__amount text-grey">ARS$ 155500.00</p>
            <Link className="item__link" to="/purchase-detail">Ver detalle</Link>
            <p className="item__quantity">1 Unidad</p>
          </div>
        </div>
      ))}
    </div>
